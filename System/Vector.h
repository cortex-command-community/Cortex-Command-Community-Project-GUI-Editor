...
namespace RTE {
	...
	static constexpr double c_TwoPI = 6.2831853;
	static constexpr double c_PI = 3.1415926;
	static constexpr double c_HalfPI = 1.5707963;
	static constexpr double c_QuarterPI = 0.7853982;
	static constexpr double c_EighthPI = 0.3926991;
	static constexpr double c_SixteenthPI = 0.1963495;
